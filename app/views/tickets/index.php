    ...
    <div class="row">
        ...
        <div class="col-md-8">
            ...
            <div class="mb-3 text-start">
                <a href="<?= URLROOT ?>/tickets/create" class="btn btn-danger" style="background-color:rgb(121, 6, 13);">
                    ReserveringsPlan
                </a>
            </div>
                        ...
                        <tbody>
                            <?php foreach ($data['tickets'] as $tickets): ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?= URLROOT ?>/Tickets/scan?barcode=<?= $tickets->Opmerking ?>" class="btn btn-primary btn-sm">Scan</a>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <a href="<?= URLROOT ?>/tickets/update/<?= $tickets->Id ?>" class="btn btn-primary btn-sm">Wijzig</a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
